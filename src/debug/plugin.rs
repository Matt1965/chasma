...
impl Plugin for DebugOverlayPlugin {
    fn build(&self, app: &mut App) {
        ...
        #[cfg(feature = "dev")]
        {
            ...
            use super::overlay::{
                DebugOverlaySystems, RelationshipLinkLabelIndex, draw_blueprint_debug_overlay,
            ...
            use super::settings::{
                ...
                run_debug_path_overlay, run_debug_relationship_links_overlay,
            ...
            app.init_resource::<InteractionDebugSnapshot>()
                ...
                .init_resource::<RelationshipLinkLabelIndex>()
                .add_systems(
                    Startup,
                    (
                        setup_navigation_mask_overlay_assets,
                        setup_relationship_link_labels_overlay,
                    ),
                )
                .add_systems(
                    Update,
                ...
                .add_systems(
                    ...
                    (
                        ...
                        project_relationship_link_label_positions
                            .after(draw_relationship_links_overlay)
                            .run_if(run_debug_relationship_links_overlay),
                    )
                        .chain()
