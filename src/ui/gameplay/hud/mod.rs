...
#[cfg(test)]
pub use assets::HudFrameBackground;
#[cfg(test)]
pub use frames::{HudPlateFrame, HudPlateSection};
#[cfg(test)]
pub use geometry::{compute_hud_viewport_geometry, roster_content_width};
pub use section::{
...
#[cfg(test)]
pub use assets::HUD_PLATE_BACKING_PATH;
