...
pub use footprint::{
    ...
    effective_building_footprint, inline_building_footprint, inline_footprint_from_building,
...
pub use registration::{
    OccupancyCatalogs, OccupancyRegistrationPlan, apply_registration_plan, plan_register_building,
    plan_register_doodad, plan_unregister_source, rebuild_occupancy_index,
    register_building_occupancy, register_doodad_occupancy, unregister_source_occupancy,
    update_building_occupancy, update_doodad_occupancy,
};
