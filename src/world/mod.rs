...
pub use unit::{
    ...
    ChunkUnitStore, CombatState, EntranceTraversalTrace, InsideMoveTrace, InteriorExitClickTrace,
    MovementAuthorityTrace, MovementAuthorityViolation, MovementBlockedAuthorityRecord,
    MovementCommandAuthorityRecord, PortalTransitionEvent, PortalTransitionTrace,
    PostExitJitterTrace, RemovalReason, UnitAuthoringError, UnitCatalog, UnitCatalogError,
    ...
    initialize_unit_navigation_membership_if_surface, issue_unit_order, lookup_unit, move_unit,
