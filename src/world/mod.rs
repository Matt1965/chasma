...
pub use building::{
    ...
    BuildingNavigationRuntime, BuildingNavigationRuntimeStore, BuildingOperationParams,
    BuildingOperationPolicy, BuildingOperationSaveState, BuildingOperationState,
    ...
    BuildingPlacementValidation, BuildingProductionSaveState, BuildingProductionStore,
    BuildingRebuildError, BuildingRecord, BuildingRenderKey, BuildingRestoreError, BuildingSource,
    BuildingSpaces, BuildingTerrainAssessment, BuildingTerrainAssessmentKey,
    BuildingTerrainAssessmentStore, BuildingTerrainWarning, BuildingTransformCandidate,
    BuildingTransformCatalogs, BuildingTransformEditError, BuildingTransformEditOptions,
    BuildingTransformEditReport, BuildingVariantCreateInput, BuildingVariantCreateOutcome,
    BuildingVitals, ChunkBuildingStore, ConstructionState, ControlSource,
    DEFAULT_EXTERIOR_STAGING_OFFSET, DoorAccessPolicy, DoorId, DoorRecord, DoorState, DoorStore,
    ENTRANCE_CORNER_MARGIN, EfficiencyBasisPoints, EntranceGenerationDiagnostics,
    FieldResponseEvaluationError, FieldResponsePoint, FieldResponseProfileCatalog,
    FieldResponseProfileCatalogRevision, FieldResponseProfileDefinition, FieldResponseProfileError,
    FieldResponseProfileId, FootprintSpec, FootprintType, GeometryGenerationDiagnostics,
    INTERACTION_WORK_RANGE_METERS, InteractionPointDefinition, InteriorActivationCatalogs,
    ...
    RuntimeNavigationFloor, RuntimeNavigationRegion, TerrainAssessmentCatalogs,
    TerrainAssessmentError, activate_building_interior, add_building_construction_progress,
    add_entrance_on_floor, add_region_connection, add_region_on_floor, add_stair_transition,
    anchor_from_terrain_position, apply_blueprint_to_asset, apply_dev_complete_building_state,
    assess_building_terrain, assess_building_terrain_at_placement, assess_production_execution,
    blueprint_id_for_building, build_building_placement_plan, building_anchor_render_transform,
    building_container_access_policy, building_has_model_correction,
    building_inventories_with_role, building_inventory_bindings, building_inventory_operational,
    ...
    can_unit_access_building_inventory, can_unit_access_inventory, classify_blueprint_authority,
    close_door, combine_output_efficiency, count_inheriting_instances, create_building,
    ...
    delete_transition, destroy_building, destroy_door, effective_inventory_binding_definitions,
    evaluate_field_response, execute_production_cycle, export_building_catalog_snapshot,
    export_navigation_blueprint_catalog, exterior_staging_for_entrance, field_value_from_percent,
    field_value_to_percent_display, format_coverage_display, format_efficiency_display,
    format_field_average_display, format_region_deletion_error,
    ground_and_quantize_building_anchor, hash_sample_cells, heal_building, insert_vertex_on_edge,
    interaction_point_world_position, interior_agent_fits_region,
    interior_navigation_move_target_at_position, interior_position_walkable,
    interior_segment_respects_region_boundary, is_building_operational,
    ...
    move_transition_from, move_transition_to, nearest_boundary_projection_entrance, open_door,
    ...
    primary_building_inventory_id, quantize_placement_anchor_xz,
    rebuild_all_building_terrain_assessments, rebuild_building_terrain_assessment,
    rebuild_building_world_indexes, refresh_building_navigation_runtime, region_interior_point,
    region_references, remove_building, replace_building_instance_definition,
    reposition_building_navigation_runtime, reset_instance_to_asset, reset_production_progress,
    resolve_building_field_sample_cells, resolve_building_inventory_binding,
    resolve_building_navigation_blueprint, resolve_move_goal_space,
    resolve_navigation_space_at_position, resolve_navigation_start_space, rotation_from_quadrants,
    save_instance_blueprint, set_building_container_locked, set_building_lifecycle_stage,
    ...
    suggest_variant_definition_id, transition_to_ruins, try_activate_interior_if_complete,
    try_open_door_at_portal_for_unit, try_open_door_for_unit, update_building_transform,
...
pub use navigation::{
    ...
    NavigationWaypoint, cell_walkability_sample_globals, find_path, find_path_in_spaces,
    find_path_with_spaces, grid_cell_center_global, grid_cell_world_position,
    grid_coord_at_global_xz, grid_coord_at_position, inset_polygon_toward_centroid,
    is_cell_walkable, is_cell_walkable_in_space, is_position_walkable,
    is_position_walkable_in_space, is_segment_walkable_in_space, measure_interior_region_clearance,
    resolve_path_endpoint_cell, signed_distance_to_polygon_edges, xz_distance,
};
pub use obstacle::{
...
pub use settlement::{
    ...
    DepositGoldReport, EMERGENCY_EVAL_CADENCE_TICKS, EmergencyCatalog, EmergencyDefinition,
    EmergencyEvaluationReport, EmergencyEvaluationStore, EmergencyEvaluatorKind, EmergencyId,
    EmergencyInterruptionPolicy, EmergencyValidationError, ExpectedEffect, HIGH_INTENT_PRIORITY,
    HIGH_PRESSURE_THRESHOLD, INTENT_ARBITRATION_CADENCE_TICKS, INTENT_PROPAGATION_CADENCE_TICKS,
    IgnoredBuilding, IntentId, IntentPersistence, IntentRejectionReason, IntentValidationError,
    ItemDemandEntry, MAX_BUILDINGS_PER_INTENT_HIGH, MAX_BUILDINGS_PER_INTENT_NORMAL,
    MAX_INTENTS_PER_NEED_HIGH, MAX_INTENTS_PER_NEED_NORMAL, MAX_SETTLEMENT_INTENTS,
    MIN_ARBITRATION_SCORE, NEED_EVAL_CADENCE_TICKS, NeedBlockingReason, NeedCatalog,
    NeedCatalogError, NeedCategory, NeedDefinition, NeedEvalContext, NeedEvaluationMethod,
    NeedEvaluationStore, NeedEvaluationValidationError, NeedId, NeedMeasurementType,
    NeedResponseCategory, NeedSnapshot, NeedTarget, NeedTargetSource, NeedTrend,
    PlacementSearchBudget, PlacementSearchResult, PlannerBuildingDecision, PlannerDiagnostics,
    PlannerShortageKind, PlannerValidationError, ProductionPlannerSaveState,
    ProductionPlannerStore, ProductionPriorityCategory, PropagationContext,
    PropagationValidationError, RESPONSE_DISCOVERY_CADENCE_TICKS, RejectedIntentCandidate,
    RejectedSiteDiagnostic, ResponseAvailability, ResponseBlockingReason, ResponseCandidateStore,
    ResponseCandidateValidationError, ResponseCatalog, ResponseCatalogError, ResponseDefinition,
    ResponseDiscoveryContext, ResponseId, ResponseType, STRATEGIC_TASK_GEN_CADENCE_TICKS,
    SettlementEmergencyState, SettlementId, SettlementIntent, SettlementIntentPlan,
    SettlementIntentStore, SettlementKind, SettlementModifier, SettlementModifierSource,
    ...
    best_building_candidate, building_owned_by_intent_propagation,
    building_supports_settlement_treasury, can_unit_deposit_to_treasury, cancel_construction_plan,
    create_plan_from_manual_placement, create_settlement_with_treasury,
    default_need_targets_for_kind, deposit_gold, discover_capable_buildings,
    discover_settlement_responses, discover_settlement_responses_now,
    ...
    propagate_building_intent_now, propagate_settlement_intent_to_buildings,
    reconcile_settlement_building_membership, replan_settlement_production, score_candidate,
    search_placement_candidates, select_building_candidates, settlement_interaction_position,
...
pub use unit::{
    ...
    ChunkUnitStore, CombatState, MovementAuthorityTrace, MovementAuthorityViolation,
    MovementBlockedAuthorityRecord, MovementCommandAuthorityRecord, PortalTransitionEvent,
    PortalTransitionTrace, RemovalReason, UnitAuthoringError, UnitCatalog, UnitCatalogError,
    ...
    unit_record_can_execute_actions, waypoint_space_ids,
};
#[cfg(any(test, feature = "dev"))]
pub use unit::{
