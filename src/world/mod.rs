...
pub use asset_sizing::{
    ...
    building_baseline_render_scale, building_model_child_local_transform,
    building_uses_model_child, building_visual_footprint_mismatch_warning, building_visual_scale,
    calculate_baseline_scale, compose_visual_scale, definition_visual_baseline,
...
pub use building::merge_starter_extensions_into_catalog;
#[cfg(any(test, feature = "dev"))]
...
pub use building::{
    AssessmentRebuildOutcome, AssessmentRebuildReport,
    BUILDING_NAVIGATION_BLUEPRINT_CATALOG_RON_PATH, BlueprintAuthoritySource,
    BlueprintDiagnosticFocus, BlueprintDiagnosticLevel, BlueprintEditOutcome,
    BlueprintInspectionValidation, BlueprintPersistenceOutcome, BuildingAuthoringError,
    BuildingCapabilities, BuildingCatalog, BuildingCatalogError, BuildingCatalogRevision,
    ...
    BuildingDefinition, BuildingDefinitionId, BuildingFieldRequirementAssessment,
    ...
    BuildingFieldRequirementKind, BuildingId, BuildingInsertError, BuildingInteractionProfile,
    BuildingInteractionProfileCatalog, BuildingInteriorState, BuildingInventoryBinding,
    BuildingInventoryBindingDefinition, BuildingInventoryBindingId, BuildingInventoryBindingSet,
    BuildingInventoryBindingStore, BuildingInventoryBindingValidationIssue, BuildingInventoryRole,
    ...
    BuildingTransformEditOptions, BuildingTransformEditReport, BuildingVariantCreateInput,
    BuildingVariantCreateOutcome, BuildingVitals, BuildingWorkPriorityLevel, ChunkBuildingStore,
    ConstructionState, ControlSource, DEFAULT_EXTERIOR_STAGING_OFFSET, DoorAccessPolicy, DoorId,
    DoorRecord, DoorState, DoorStore, ENTRANCE_CORNER_MARGIN, EfficiencyBasisPoints,
    ...
    NavigationBlueprintCacheManifest, NavigationBlueprintGenerationStatus,
    NavigationEntranceDefinition, NavigationFloorDefinition, NavigationPolygon2d,
    NavigationReconcileOutcome, NavigationRegionDefinition, NavigationVerticalTransitionDefinition,
    NavigationVerticalTransitionKind, OperationDefinitionId, OperationLifecycle,
    ...
    add_region_on_floor, add_stair_transition, anchor_from_terrain_position,
    apply_blueprint_to_asset, apply_dev_complete_building_state,
    apply_player_building_work_priority, apply_player_production_enabled,
    apply_player_production_selected_operation, apply_player_storage_accept_all,
    ...
    building_navigation_movement_authority, building_operational_efficiency,
    building_storage_accepts_item, building_storage_accepts_item_for_definition,
    building_storage_policy, building_uses_blueprint_movement_authority,
    ...
    building_work_priority_u8_for_level, can_unit_access_building_inventory,
    can_unit_access_inventory, capture_building_navigation_topology_snapshot,
    classify_blueprint_authority, close_door, combine_output_efficiency,
    count_inheriting_instances, create_building, create_building_variant,
    create_building_with_inventory, create_dev_complete_building,
    create_dev_complete_building_with_inventory, cycle_production_selected_operation,
    damage_building, deactivate_building_interior, default_building_inventory_binding,
    definition_requires_inventory_allocation, delete_entrance, delete_floor_vertex, delete_region,
    delete_region_connection, delete_transition, destroy_building, destroy_door,
    effective_inventory_binding_definitions, effective_storage_category_accepted,
    evaluate_field_requirement, evaluate_field_requirement_assessment, evaluate_field_response,
    execute_production_cycle, export_building_catalog_snapshot,
    export_navigation_blueprint_catalog, exterior_staging_for_entrance, farm_growth_percent,
    farm_harvest_percent, farm_needs_harvest_worker, field_value_from_percent,
    field_value_to_percent_display, format_coverage_display, format_efficiency_display,
    format_field_average_display, format_field_requirement_diagnostic,
    format_region_deletion_error, ground_and_quantize_building_anchor, hash_sample_cells,
    heal_building, insert_vertex_on_edge, interaction_point_world_position,
    interior_agent_fits_region, interior_navigation_move_target_at_position,
    interior_position_walkable, interior_segment_respects_region_boundary, is_building_operational,
    is_prispod_farm_definition, load_building_field_requirement_catalog,
    load_building_navigation_blueprint_catalog, load_field_response_profile_catalog, lock_door,
    lookup_building, mark_settlement_storage_logistics_wakeup,
    mark_storage_logistics_dirty_for_inventory, migrate_entrances_toward_boundaries,
    min_edge_clearance_meters, move_building, move_connection_from, move_connection_to,
    move_entrance, move_floor_vertex, move_transition_from, move_transition_to,
    movement_authority_label, nearest_boundary_projection_entrance, open_door,
    place_player_building, place_player_building_with_inventory, point_in_polygon_xz,
    portal_traversable, position_in_surface_entrance_portal, prepare_blueprint_for_save,
    primary_building_inventory_id, primary_failure_for_assessment,
    probe_segment_crosses_entrance_opening, progress_to_percent, quantize_placement_anchor_xz,
    rebuild_all_building_terrain_assessments, rebuild_building_terrain_assessment,
    rebuild_building_world_indexes, reconcile_all_building_navigation_runtimes,
    reconcile_building_navigation_runtime, reconcile_farm_harvest_phase,
    refresh_building_navigation_runtime, region_interior_point, region_references, remove_building,
    ...
    set_building_container_locked, set_building_lifecycle_stage, set_building_work_priority,
    set_connection_radius, set_entrance_radius, set_entrance_region_key, set_production_enabled,
    set_production_execution_mode, set_production_paused, set_production_repeat_count,
    set_production_selected_operation, set_transition_radius, snap_anchor_global_xz,
    space_route_for_unit, spill_position_for_building, step_all_building_construction,
    step_all_farm_passive_growth, step_workstation_operation, storage_item_is_misfiled,
    suggest_variant_definition_id, surface_blueprint_support_blocks_position,
    ...
    surface_segment_respects_blueprint_boundaries, transition_to_ruins,
    try_activate_interior_if_complete, try_open_door_at_portal_for_unit, try_open_door_for_unit,
    unit_within_building_inventory_range, update_building_transform,
    validate_blueprint_for_inspection, validate_building_catalog_inventory_bindings,
    validate_building_definition_id, validate_building_definition_inventory_bindings,
    validate_building_for_restore, validate_building_inventory_links,
    validate_building_inventory_owner, validate_building_placement,
    validate_building_runtime_inventory_bindings, validate_building_transform_placement,
    validate_operation_inventory_bindings, validate_production_runtime,
    validate_production_runtime_with_catalogs, validate_selected_operation_inventory_bindings,
    validate_world_building_inventory_bindings, workstation_workers_for_building,
};
pub use building::{
...
pub use building::{
    hash_asset_path, import_navigation_blueprints_for_catalog,
...
#[cfg(feature = "dev")]
pub use interaction::trace_and_resolve_world_click_to_order;
pub use interaction::{
...
pub use inventory::{
    ...
    reference_weight_is_soft_encumbrance, remove_entry, remove_inventory, remove_owned_inventory,
...
pub use item_pile::{
    ...
    pickup_pile_into_inventory, pile_item_definition_id, spill_inventory_to_world_piles,
    update_item_pile_placement, update_item_pile_transform, validate_item_instance_locations,
    validate_item_pile_store,
};
pub use logistics::{
    BuildingLogisticsRouteDefinition, HaulTickReport, HaulingRequest, HaulingRequestId,
    HaulingRequestPriority, HaulingRequestStatus, LogisticsEndpointIndex, LogisticsRouteTrigger,
    LogisticsSaveState, assign_hauling_task, assign_hauling_task_with_priority,
    available_stack_quantity, cancel_hauling_request, cancel_logistics_for_building_removal,
    deposit_haul_cargo, destination_can_fit_stack_quantity, export_logistics_save_state,
    force_complete_hauling_request, import_logistics_save_state, pickup_haul_cargo,
    register_building_logistics_endpoints, reserve_hauling_request, retry_blocked_hauling_requests,
    spawn_manual_hauling_request, step_haul_worker_tasks, sync_dirty_storage_logistics,
    sync_logistics_requests_from_assessment, sync_misfiled_storage_for_building,
    sync_output_surplus_after_production, unregister_building_logistics_endpoints,
};
...
pub use navigation::{
    GridCoord, InteriorCellFailureReason, InteriorCellProbe, InteriorRegionClearanceReport,
    NEIGHBOR_OFFSETS, NavigationAgent, NavigationConfig, NavigationError, NavigationPath,
    NavigationSegmentBlockReason, NavigationSegmentLegality, NavigationWaypoint,
    cell_walkability_sample_globals, find_path, find_path_in_spaces, find_path_with_spaces,
    grid_cell_center_global, grid_cell_world_position, grid_coord_at_global_xz,
    grid_coord_at_position, inset_polygon_toward_centroid, is_cell_walkable,
    is_cell_walkable_in_space, is_position_walkable, is_position_walkable_in_space,
    is_segment_walkable_in_space, measure_interior_region_clearance, navigation_segment_valid,
    query_navigation_point_legality, query_navigation_segment_legality,
    resolve_entrance_interior_planning_anchor, resolve_path_endpoint_cell,
    signed_distance_to_polygon_edges, xz_distance,
};
pub use obstacle::{
...
pub use settlement::{
    ...
    BuildingPolicyAssignment, CONSTRUCTION_PLANNING_CADENCE_TICKS, CandidateResponse,
    CapabilityRequirement, CapableBuilding, CapacityGapEstimate, ConstructionCapabilityKind,
    ...
    ConstructionResponseMapping, ConstructionValidationError, CreateSettlementReport,
    DEFAULT_TOWN_BOUNDARY_RADIUS_METERS, DepositGoldReport, EMERGENCY_EVAL_CADENCE_TICKS,
    EmergencyCatalog, EmergencyDefinition, EmergencyEvaluationReport, EmergencyEvaluationStore,
    EmergencyEvaluatorKind, EmergencyId, EmergencyInterruptionPolicy, EmergencyValidationError,
    ExpectedEffect, HIGH_INTENT_PRIORITY, HIGH_PRESSURE_THRESHOLD,
    INTENT_ARBITRATION_CADENCE_TICKS, INTENT_PROPAGATION_CADENCE_TICKS, IgnoredBuilding, IntentId,
    IntentPersistence, IntentRejectionReason, IntentValidationError, ItemDemandEntry,
    ...
    NEED_EVAL_CADENCE_TICKS, NeedBlockingReason, NeedCatalog, NeedCatalogError, NeedCategory,
    ...
    NeedTarget, NeedTargetSource, NeedTrend, PlacementSearchBudget, PlacementSearchResult,
    PlannerBuildingDecision, PlannerDiagnostics, PlannerShortageKind, PlannerValidationError,
    ProductionPlannerSaveState, ProductionPlannerStore, ProductionPriorityCategory,
    PropagationContext, PropagationValidationError, RESPONSE_DISCOVERY_CADENCE_TICKS,
    RejectedIntentCandidate, RejectedSiteDiagnostic, ResponseAvailability, ResponseBlockingReason,
    ResponseCandidateStore, ResponseCandidateValidationError, ResponseCatalog,
    ResponseCatalogError, ResponseDefinition, ResponseDiscoveryContext, ResponseId, ResponseType,
    STRATEGIC_TASK_GEN_CADENCE_TICKS, SettlementAnchorId, SettlementAnchorRecord,
    SettlementAnchorStore, SettlementCreationError, SettlementEmergencyState, SettlementId,
    SettlementIntent, SettlementIntentPlan, SettlementIntentStore, SettlementKind,
    SettlementMembershipError, SettlementModifier, SettlementModifierSource,
    SettlementNeedEvaluation, SettlementOwnership, SettlementPlannerLifecycle, SettlementPolicies,
    SettlementProductionPlanner, SettlementRecord, SettlementResponseCandidates, SettlementState,
    SettlementStateSaveState, SettlementStateStore, SettlementStateValidationError,
    SettlementStore, SettlementTreasuryRecord, StockGoal, StrategicTaskCatalogError,
    StrategicTaskEmission, StrategicTaskGenContext, StrategicTaskGenerationReport,
    StrategicTaskGenerationStore, StrategicTaskTemplate, StrategicTaskTemplateCatalog,
    StrategicTaskTemplateId, StrategicTaskValidationError, TreasuryAccessPolicy,
    TreasuryAccessResult, TreasuryError, TreasuryId, TreasuryTransactionRecord,
    WorkPermissionDomain, WorkforcePermissionError, WorkforcePermissionStore,
    aggregate_settlement_stock, allow_all_unit_work_permissions, apply_pressure_modifiers,
    approve_construction_plan, arbitrate_settlement_intent, arbitrate_settlement_intent_now,
    arbitration_score, assign_building_settlement, assign_selected_units_at_position,
    assign_unit_settlement, best_building_candidate, building_supports_settlement_treasury,
    can_sa5_mutate_policy, can_unit_deposit_to_treasury, cancel_construction_plan,
    clear_settlement_workforce_permissions, clear_unit_settlement_on_removal,
    clear_unit_workforce_permissions, collect_settlement_accessible_stock,
    create_plan_from_manual_placement, create_settlement, create_settlement_with_treasury,
    default_need_targets_for_kind, deny_all_unit_work_permissions, deposit_gold,
    discover_capable_buildings, discover_settlement_responses, discover_settlement_responses_now,
    ensure_settlement_states_for_world, estimate_capacity_gap, evaluate_settlement_emergencies,
    evaluate_settlement_emergencies_now, evaluate_settlement_needs, evaluate_settlement_needs_now,
    execute_settlement_replan, generate_strategic_tasks_for_settlement,
    generate_strategic_tasks_now, intent_to_task_priority, mark_all_settlement_states_dirty,
    mark_construction_planning_dirty_from_intents, mark_settlement_planner_dirty,
    mark_settlement_state_dirty, mark_settlement_state_dirty_for_building, normalize_pressure,
    plan_construction_for_settlement, plan_construction_now, primary_operation_requirement,
    priority_category_for_need, propagate_building_intent_now,
    propagate_settlement_intent_to_buildings, rebuild_settlement_membership_indexes,
    recommend_production_for_intent, replan_settlement_production, sa5_apply_policy_decision,
    sa5_disable_unselected_ai_buildings, score_candidate, seed_building_settlement_at_creation,
    seed_unit_settlement_at_creation, set_unit_work_permission, settlement_containing_position,
    settlement_member_unit_ids, starter_construction_costs, starter_construction_mappings,
    starter_emergency_definitions, starter_need_definitions, starter_response_definitions,
    starter_strategic_task_templates, step_building_intent_propagation,
    step_settlement_construction_planning, step_settlement_emergency_evaluation,
    step_settlement_need_evaluation, step_settlement_production_planners,
    step_settlement_response_arbitration, step_settlement_response_discovery,
    step_settlement_strategic_task_generation, sum_category_count, sum_category_nutrition,
    unit_may_autonomously_perform_work, unit_physically_capable_for_work_permission,
    unit_work_allowed, validate_candidate, validate_construction_plans, validate_emergency_catalog,
    ...
    validate_settlement_response_candidates, validate_settlement_state, validate_settlement_states,
    validate_strategic_task_report, validate_world_construction_plans,
    validate_world_settlement_states, work_permission_domain_for_task,
};
#[cfg(any(test, feature = "dev"))]
...
pub use task::{
    ...
    StrategicTaskOrigin, TaskCancelReason, TaskError, TaskEvent, TaskId, TaskPriority, TaskRecord,
    TaskState, TaskStore, TaskTarget, TaskTickReport, TaskType, WORKER_ASSIGNMENT_CADENCE_TICKS,
    WorkerAssignmentContext, WorkerAssignmentReport, WorkerAssignmentStore, WorkerEvaluation,
    assign_construct_building_task, assign_operate_workstation_task,
    building_accepts_workstation_use, building_is_constructible, cancel_unit_task,
    claim_building_task, ensure_building_task, may_preempt, may_preempt_with_override,
    prune_invalid_building_tasks, release_unit_task_to_marketplace, score_marketplace_listing,
    settlement_for_building_work, step_all_worker_tasks, step_worker_assignment,
    sync_construction_tasks, sync_operate_workstation_tasks, unit_can_perform_task,
    unit_is_settlement_member, unit_may_autonomously_work_building, unit_may_work_on_building,
...
pub use terrain_field::{
    ...
    load_terrain_fields_from_manifest, package_field_layers, package_manifest_source_version,
    partition_raster_to_tiles, reload_terrain_fields_with_invalidation, resample_imported_image,
    sample_terrain_field_area, sample_terrain_field_at, target_sample_dimensions,
...
pub use unit::{
    ...
    MovementBlockedAuthorityRecord, MovementCommandAuthorityRecord, NutritionProfile,
    PortalTransitionEvent, PortalTransitionTrace, PostExitJitterTrace, RemovalReason,
    SelfMaintenanceActivity, SelfMaintenanceContext, UnitAuthoringError, UnitCatalog,
    ...
    UnitNutritionState, UnitOrder, UnitOrderError, UnitPlacement, UnitRecord, UnitRenderKey,
    UnitSelfMaintenanceState, UnitSimulationStepReport, UnitSource, UnitState, UnitVitals,
    ...
    initialize_unit_navigation_membership_if_surface, initialize_unit_nutrition,
    initialize_unit_work_skills, issue_unit_order, lookup_unit, model_forward_xz, move_unit,
    remove_unit, resolve_all_pending_unit_orders, resolve_pending_unit_orders,
    rotation_from_yaw_radians, set_work_skill_value, starter_work_skill_definitions,
    ...
    step_unit_self_maintenance_pre_work, step_yaw_toward, unit_can_execute_actions,
    unit_holds_position, unit_in_active_combat, unit_record_can_execute_actions,
    waypoint_space_ids, work_skill_for_permission_domain, work_skill_for_task, work_skill_value,
...
#[cfg(feature = "dev")]
pub use unit::{
    finish_command_resolution_failure, maybe_begin_entrance_traversal_session, maybe_begin_session,
    record_entrance_interior_first_step, record_entrance_membership_update,
    record_entrance_opening_legality_probe, record_entrance_pathfinding_probe,
    record_entrance_transition_probe, record_order_issuance,
};
...
fn reconcile_building_navigation_on_startup(
